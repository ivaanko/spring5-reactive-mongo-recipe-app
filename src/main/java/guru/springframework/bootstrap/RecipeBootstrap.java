...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        log.error("#######");
        log.error("UOM reactive repo count: " + unitOfMeasureReactiveRepository.count().block().toString());
        log.error("Cat reactive repo count: " + categoryReactiveRepository.count().block().toString());
